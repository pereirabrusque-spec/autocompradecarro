            ...
            <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'ano_modelo', key: 'ano_modelo' },
                  { label: 'placa', key: 'placa' },
                  { label: 'cor', key: 'cor' },
                  { label: 'quilometragem', key: 'quilometragem' },
                  { label: 'banco_financiamento', key: 'banco_financiamento' },
                  { label: 'valor_parcela', key: 'valor_parcela', type: 'number' },
                  { label: 'parcelas_pagas', key: 'parcelas_pagas', type: 'number' },
                  { label: 'total_parcelas', key: 'total_parcelas', type: 'number' },
                  { label: 'parcelas_atrasadas', key: 'parcelas_atrasadas', type: 'number' },
                  { label: 'entrada', key: 'entrada', type: 'number' },
                  { label: 'desired_value', key: 'desired_value', type: 'number' },
                  { label: 'multas', key: 'multas', type: 'number' },
                  { label: 'motor_reparo', key: 'motor_reparo', type: 'number' },
                  { label: 'cambio_reparo', key: 'cambio_reparo', type: 'number' },
                  { label: 'batido_reparo', key: 'batido_reparo', type: 'number' },
                  { label: 'cliente_nome', key: 'cliente_nome' },
                  { label: 'telefone', key: 'telefone' },
                  { label: 'email', key: 'email' },
                  { label: 'status', key: 'status' },
                  { label: 'data_negociacao', key: 'data_negociacao' },
                  { label: 'tipo_veiculo', key: 'tipo_veiculo' },
                  { label: 'tipo_monta', key: 'tipo_monta' },
                  { label: 'valor_ipva_multa', key: 'valor_ipva_multa', type: 'number' },
                  { label: 'juros_atraso', key: 'juros_atraso', type: 'number' },
                  { label: 'valor_ipva', key: 'valor_ipva', type: 'number' },
                  { label: 'valor_pneus', key: 'valor_pneus', type: 'number' },
                  { label: 'valor_documento', key: 'valor_documento', type: 'number' },
                  { label: 'tem_sinistro', key: 'tem_sinistro', type: 'checkbox' },
                  { label: 'passagem_leilao', key: 'passagem_leilao', type: 'checkbox' },
                  { label: 'recuperado_banco', key: 'recuperado_banco', type: 'checkbox' },
                  { label: 'historico_furto_roubo', key: 'historico_furto_roubo', type: 'checkbox' },
                  { label: 'is_financiamento_atrasado', key: 'is_financiamento_atrasado', type: 'checkbox' },
                  { label: 'is_busca_apreensao', key: 'is_busca_apreensao', type: 'checkbox' },
                  { label: 'is_ipva_multas_atrasados', key: 'is_ipva_multas_atrasados', type: 'checkbox' },
                  { label: 'is_renajud', key: 'is_renajud', type: 'checkbox' },
                  { label: 'is_motor_fundido', key: 'is_motor_fundido', type: 'checkbox' },
                  { label: 'is_cambio_defeito', key: 'is_cambio_defeito', type: 'checkbox' },
                  { label: 'is_batido_avariado', key: 'is_batido_avariado', type: 'checkbox' },
                  { label: 'is_sinistrado_leilao', key: 'is_sinistrado_leilao', type: 'checkbox' },
                  { label: 'ar_condicionado', key: 'ar_condicionado', type: 'checkbox' },
                  { label: 'direcao_hidraulica', key: 'direcao_hidraulica', type: 'checkbox' },
                  { label: 'vidros_eletricos', key: 'vidros_eletricos', type: 'checkbox' },
                  { label: 'travas_eletricas', key: 'travas_eletricas', type: 'checkbox' },
                  { label: 'alarme', key: 'alarme', type: 'checkbox' },
                  { label: 'som_multimidia', key: 'som_multimidia', type: 'checkbox' },
                  { label: 'bancos_couro', key: 'bancos_couro', type: 'checkbox' },
                  { label: 'rodas_liga_leve', key: 'rodas_liga_leve', type: 'checkbox' },
                  { label: 'sensor_re', key: 'sensor_re', type: 'checkbox' },
                  { label: 'camera_re', key: 'camera_re', type: 'checkbox' },
                  { label: 'teto_solar', key: 'teto_solar', type: 'checkbox' },
                  { label: 'airbag', key: 'airbag', type: 'checkbox' },
                  { label: 'chave_reserva_manual', key: 'chave_reserva_manual', type: 'checkbox' },
                  { label: 'revisoes_dia', key: 'revisoes_dia', type: 'checkbox' },
                  { label: 'estado_pneus', key: 'estado_pneus' },
                  { label: 'cidade_estado', key: 'cidade_estado' },
                  { label: 'renavam', key: 'renavam' },
                  { label: 'valor_fipe', key: 'valor_fipe', type: 'number' },
                  { label: 'cpf', key: 'cpf' },
                  { label: 'chassi', key: 'chassi' },
                  { label: 'hist_procedencia', key: 'hist_procedencia' },
                  { label: 'ano_fabricacao', key: 'ano_fabricacao' }
                ].filter(field => {
