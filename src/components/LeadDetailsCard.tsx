            ...
            <div className="bg-white p-6 rounded-[32px] border border-slate-200 shadow-sm space-y-4 mb-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  ...
                  { label: 'Ar Condicionado', key: 'ar_condicionado', type: 'checkbox' },
                  { label: 'Direção Hidráulica', key: 'direcao_hidraulica', type: 'checkbox' },
                  { label: 'Vidros Elétricos', key: 'vidros_eletricos', type: 'checkbox' },
                  { label: 'Travas Elétricas', key: 'travas_eletricas', type: 'checkbox' },
                  { label: 'Alarme', key: 'alarme', type: 'checkbox' },
                  { label: 'Som / Multimídia', key: 'som_multimidia', type: 'checkbox' },
                  { label: 'Bancos de Couro', key: 'bancos_couro', type: 'checkbox' },
                  { label: 'Rodas de Liga Leve', key: 'rodas_liga_leve', type: 'checkbox' },
                  { label: 'Sensor de Ré', key: 'sensor_re', type: 'checkbox' },
                  { label: 'Câmera de Ré', key: 'camera_re', type: 'checkbox' },
                  { label: 'Teto Solar', key: 'teto_solar', type: 'checkbox' },
