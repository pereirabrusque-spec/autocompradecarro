...
export default function WhatsAppButton({ forceShow = false }: { forceShow?: boolean }) {
  ...
  return (
    <a 
      ...
      className="fixed md:bottom-8 bottom-[calc(2rem+env(safe-area-inset-bottom))] right-8 z-50 bg-[#25D366] text-white p-4 rounded-full shadow-2xl hover:bg-[#128C7E] transition-all hover:scale-110 flex items-center gap-2 group animate-pulse-soft"
      title={text}
    >
